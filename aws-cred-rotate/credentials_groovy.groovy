...
def updateCredential(mystring) { 
    def id = mystring.split(":")[0]
    def old_access_key = mystring.split(":")[1]
    def new_access_key = mystring.split(":")[2]
    def new_secret_key  = mystring.split(":")[3]
